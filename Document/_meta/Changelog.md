...
- 버전 3.5.1 → 3.6.0 범프(전 5패키지). 태그 v3.6.0 푸시 → NuGet Publish 워크플로 5패키지 게시 확인(워크플로 1m33s 성공, nuget.org 인덱싱 확인).
...
- 버전 3.5.0 → 3.5.1 범프(전 5패키지). 로컬 게이트 통과: 솔루션 전체 빌드 오류 0 + 144 테스트(52/52/40). 태그 v3.5.1 푸시 → NuGet Publish 워크플로 5패키지 게시 확인(워크플로 1m25s 성공, nuget.org 인덱싱 확인).
