...
Current versions: DRPC packages **3.3.0** (release tags are authoritative), `MessageProtocol` **3.1.0** (the unified `[Message]` attribute — see below), `Communication.Network.RUDP.*` / `Communication.Shared` **2.7.0**.
